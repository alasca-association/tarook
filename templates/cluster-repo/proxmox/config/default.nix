...
in {
  yk8s = {
    ...
    proxmox = {
      enabled = true;
      ipv4_gateway_address = "192.168.67.1";
      pool_id = "Tarook-Dev";
      clone.vm_id = 109;
      ...
      nodes = let
        ...
        mkWorkerNode = values: lib.foldl' lib.recursiveUpdate node_defaults [worker_defaults values];
