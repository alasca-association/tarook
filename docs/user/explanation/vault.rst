...
The ``vault/init.sh`` script (see :ref:`vault.tools`) creates Vault policies which
...
LCM. It has sufficient privileges to execute all scripts listed in :ref:`vault.tools`,
