...
2. Determine which rook version is currently deployed. It should be the
   currently configured rook version in your managed Tarook cluster
...
4. Depending on the currently deployed rook version, determine the
   *next* (supported) minor release. The managed Tarook cluster
...
-  **Test your changes**
   ...
   -  Configure the new rook version in your managed Tarook cluster
      configuration
