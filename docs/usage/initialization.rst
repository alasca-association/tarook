...
serve as your :doc:`cluster repository </concepts/cluster-repository>`:
...
3. Setup your environment variables:
   ...
   2. Make the
      ...
      to ``./.envrc``.
   3. Make sure to they have taken effect by running ``direnv allow``.
...
4. Run ``./managed-k8s/tools/vault/mkcluster-root.sh devcluster``. Note that ``devcluster``
