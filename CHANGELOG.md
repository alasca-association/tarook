...
## Add support for rook v1.9.12
Update by setting `version=1.9.12` and running `MANAGED_K8S_RELEASE_THE_KRAKEN=true AFLAGS="--diff --tags mk8s-sl/rook" managed-k8s/actions/apply-stage4.sh`
