...
- A new environment group ``yk8s-env.update-inventory`` has been added, so :ref:`update-inventory.sh<actions-references.update-inventorysh>` can be run without downloading unnecessary dependencies. (`!1921 <https://gitlab.com/yaook/k8s/-/merge_requests/1921>`_)
