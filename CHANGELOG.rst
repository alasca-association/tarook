...
- Some external references in the changelogs have been fixed. (`!2646 <https://gitlab.com/alasca.cloud/tarook/tarook/-/merge_requests/2646>`_)
...
- HashiCorp `rotated their Linux package signing key <https://status.hashicorp.com/incidents/ey12gp4e>`__ on 2026-09-09.
  ...
  _ (`!2639 <https://gitlab.com/alasca.cloud/tarook/tarook/-/merge_requests/2639>`_)
...
- It is now ensured that the ``cri-tools`` package is installed
  ...
  (< 1.33.12-1.1, < 1.34.8-1.1, < 1.35.5-1.1). (`!2487 <https://gitlab.com/alasca.cloud/tarook/tarook/-/merge_requests/2487>`_)
