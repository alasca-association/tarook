...
- Depending on the IP version enabled, node address autodetection is explicitly set to ``{}``. (`!1755 <https://gitlab.com/yaook/k8s/-/merge_requests/1755>`_)
...
- Fix IP address autodetection in Calico when used with VRRP on the hosts
  ...
  address conflict. (`!1755 <https://gitlab.com/yaook/k8s/-/merge_requests/1755>`_)
...
- :ref:`The script to import signed intermediates into Vault
  ...
  during the implementation of root CA rotation support. (`!1657 <https://gitlab.com/yaook/k8s/-/merge_requests/1657>`_)
...
- The Kubernetes upgrade procedure has been fixed and adjusted such that it more strictly follows the `official documentation <https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade/>`_.
  ...
  This fixes a regression which prevented control plane components to properly update to the next Kubernetes version. (`!1581 <https://gitlab.com/yaook/k8s/-/merge_requests/1581>`_)
...
- The Kubernetes apt key expired and is now updated. (`!1548 <https://gitlab.com/yaook/k8s/-/merge_requests/1548>`_)
