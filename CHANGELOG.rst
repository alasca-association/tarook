...
- The root CA rotation has been fixed. (`!1290 <https://gitlab.com/yaook/k8s/-/merge_requests/1290>`_)
...
- The LCM is again able to retrieve the default subnet CIDR
  when ``[terraform].subnet_cidr`` is not set in the config.toml. (`!1248 <https://gitlab.com/yaook/k8s/-/merge_requests/1248>`_)
