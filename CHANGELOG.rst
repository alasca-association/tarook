...
- The CA rotation procedure has been fixed once again
  including force-renewal of the certificates and kubeconfig on Kubernetes nodes. (`!1934 <https://gitlab.com/yaook/k8s/-/merge_requests/1934>`_)
...
- Depending on the IP version enabled, node address autodetection is explicitly set to ``{}``. (`!1754 <https://gitlab.com/yaook/k8s/-/merge_requests/1754>`_)
...
- Fix IP address autodetection in Calico when used with VRRP on the hosts
  ...
  address conflict. (`!1754 <https://gitlab.com/yaook/k8s/-/merge_requests/1754>`_)
...
- Due to a vulnerability in the ingress-nginx admission controller, ingress-nginx has been updated. (`!1762 <https://gitlab.com/yaook/k8s/-/merge_requests/1762>`_)
...
- :ref:`The script to import signed intermediates into Vault
  ...
  was fixed
  after it was accidentally broken
  during the implementation of root CA rotation support. (`!1623 <https://gitlab.com/yaook/k8s/-/merge_requests/1623>`_)


Misc
~~~~

- `!1627 <https://gitlab.com/yaook/k8s/-/merge_requests/1627>`_
...
- The Kubernetes upgrade procedure has been fixed and adjusted such that it more strictly follows the `official documentation <https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade/>`_.
  ...
  This fixes a regression which prevented control plane components to properly update to the next Kubernetes version. (`!1580 <https://gitlab.com/yaook/k8s/-/merge_requests/1580>`_)
...
- The Kubernetes apt key expired and is now up-to-date again. (`!1546 <https://gitlab.com/yaook/k8s/-/merge_requests/1546>`_)
- A PATH issue in the hotfixing pipeline is fixed. (`!1546 <https://gitlab.com/yaook/k8s/-/merge_requests/1546>`_)
