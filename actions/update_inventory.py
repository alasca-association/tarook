...
from helpers import tofu_helper
...
def main():
    ...
    * Process each section
    ...
    if (os.getenv('TF_USAGE', 'true') == 'true'):
        print_process_state("OpenTofu")
        tf_config = config.get("opentofu")
        # If we want to use thanos, then the user can decide if tofu should create
        ...
        tofu_helper.deploy_tofu_config(tf_config)
    ...
    if (os.getenv('WG_USAGE', 'true') == 'true'):
        ...
        if (os.getenv('wg_user') == 'gitlab-ci-runner'):  # if in gitlab ci
            ...
            tf_ipv4_string = (
                tofu_helper.get_default_value_in_tf_vars('subnet_cidr')
            )
        ...
        if (
            ...
            if 'subnet_v6_cidr' in tf_config:
                ...
                tf_ipv6_string = (
                    tofu_helper.get_default_value_in_tf_vars('subnet_v6_cidr')
                )
