...
"""
Wrapper module for the utils/create_ssh_conf.py. Offers an action to
re-generate the custom ssh-config for the dynamic cloud inventory.
"""
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        cmd = f"python3 {task_vars['playbook_dir']}/utils/create_ssh_conf.py \
                        {task_vars['hosts_file']}".split(" ")
