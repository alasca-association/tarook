...
import_cert k8s-cluster.fullchain.pem "$k8s_pki_path" "current"
import_cert k8s-front-proxy.fullchain.pem "$k8s_front_proxy_pki_path" "current"
import_cert k8s-etcd.fullchain.pem "$etcd_pki_path" "current"
