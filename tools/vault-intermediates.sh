...
vault secrets tune -max-lease-ttl="$pki_intermediate_ttl" "$k8s_pki_path"
vault secrets tune -max-lease-ttl="$pki_intermediate_ttl" "$k8s_front_proxy_pki_path"
vault secrets tune -max-lease-ttl="$pki_intermediate_ttl" "$calico_pki_path"
vault secrets tune -max-lease-ttl="$pki_intermediate_ttl" "$etcd_pki_path"

vault write "$k8s_pki_path/intermediate/generate/internal" \
    common_name="$cluster Kubernetes Cluster Intermediate CA 2022" \
...
vault write "$etcd_pki_path/intermediate/generate/internal" \
    common_name="$cluster Kubernetes etcd Intermediate CA 2022" \
    ttl="$pki_intermediate_ttl" \
    key_type=ed25519
...
vault write "$k8s_front_proxy_pki_path/intermediate/generate/internal" \
    common_name="$cluster Kubernetes Front Proxy Intermediate CA 2022" \
    ttl="$pki_intermediate_ttl" \
    key_type=ed25519
...
vault write "$calico_pki_path/intermediate/generate/internal" \
    common_name="$cluster Kubernetes calico Intermediate CA 2022" \
    ttl="$pki_intermediate_ttl" \
    key_type=ed25519
