        ...
        installation = {
          ...
          calicoNetwork.mtu = mkOption {
            ...
            default =
              ...
              # TODO: @proxmox::MTU
              # Add calculation if Proxmox support is stable.
              # Proxmox support is currently in alpha state,
              # the MTU may need to be adjusted manually.
              else 1500;
