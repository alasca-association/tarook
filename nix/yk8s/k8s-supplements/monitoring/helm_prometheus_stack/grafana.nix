    ...
    grafana = {
        ...
        "datasources.yaml" = {
          ...
          datasources =
            lib.optional cfg.use_thanos
            {
              ...
              access = "proxy";
              orgId = 1;
              url = "http://thanos-query.${cfg.thanos.helm.release_namespace}.svc:9090";
              version = 2; # NOTE: This value needs to be increased every time something changes in this datasource definition
              editable = true;
      ...
      sidecar = {
        dashboards = {
          ...
          multicluster.global.enabled = cfg.grafana_dashboard_enable_multicluster_support;
        };
      };
      serviceMonitor = {
        enabled = true;
      ...
      dashboards = {
        managed =
          ...
          // (lib.optionalAttrs config.yk8s.k8s-service-layer.rook.enabled {
