        ...
        options = {
          ...
          ipv6_cidr = mkOption {
            description = ''
              ...
              to tear down tunnels.
            '';
            type = types.nullOr types.yk8s.networking.ipv6Cidr;
            default = null;
            example = "fd01::/120";
          };
          ipv6_gw = mkOption {
    ...
    peers = mkOption {
      ...
      type = types.listOf (types.submodule {
        options = {
          ...
          ip = mkOption {
            type = with types; nullOr types.yk8s.networking.ipv4Addr;
            default = null;
          };
          ips = mkOption {
            type = with types; attrsOf (either types.yk8s.networking.ipv4Cidr types.yk8s.networking.ipv4Addr);
            default = {};
          };
          ipv6 = mkOption {
          ...
          ipsv6 = mkOption {
            type = with types; attrsOf (either types.yk8s.networking.ipv6Cidr types.yk8s.networking.ipv6Addr);
            default = {};
          };
        };
      });
