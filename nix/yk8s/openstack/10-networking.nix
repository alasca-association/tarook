...
in {
  yk8s.terraform.modules = lib.mkIf cfg.enabled (
    [
      {
        ...
        resource.openstack_networking_secgroup_v2.barndoor = [
          {
            description = "A barndoor wide open. Allows ANY kind of traffic.";
            name = "barndoor";
          }
        ];
        ...
        output.floating_ip_network_id.value = yk8s-lib.tfRef "data.openstack_networking_network_v2.public_network.id";
      }
    ]
    ...
    ++ (lib.optional config.yk8s.infra.ipv6_enabled {
      ...
      resource.openstack_networking_secgroup_rule_v2.barndoor-ipv6-icmp-egress = {
        _import_from = "openstack_networking_secgroup_rule_v2.barndoor-ipv6-icmp-egress[0]";
        direction = "egress";
        ethertype = "IPv6";
        protocol = "ipv6-icmp";
        security_group_id = yk8s-lib.tfRef "openstack_networking_secgroup_v2.barndoor.id";
