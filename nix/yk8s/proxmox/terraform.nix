            ...
            ip_config =
              ...
              (lib.optionalAttrs config.yk8s.infra.ipv4_enabled {
                ipv4 = let
                  ...
                  subnet_suffix = builtins.head (builtins.match "^${ipv4AddrRE}(${ipv4SuffixRE})$" config.yk8s.infra.subnet_cidr);
                in {
              ...
              // (lib.optionalAttrs config.yk8s.infra.ipv6_enabled {
                ipv6 = let
                  ...
                  subnet_suffix = builtins.head (builtins.match "^${ipv6AddressRE}(${ipv6SuffixRE})$" config.yk8s.infra.subnet_v6_cidr);
                in {
