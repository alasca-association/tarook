...
in {
  ...
  options.yk8s.miscellaneous = mkTopSection {
    ...
    http_proxy = mkOption {
      ...
      '';
      type = with types; nullOr types.yk8s.networking.httpHostPathUrl;
      default = null;
    ...
    https_proxy = mkOption {
      description = ''
        ...
        will be set automagically and do not have to set manually here.
      '';
      type = with types; nullOr types.yk8s.networking.httpsHostPathUrl;
      default = null;
    ...
    no_proxy = mkOption {
      description = ''
        ...
        will be set automagically and do not have to set manually here.
      '';
      type = with types; nullOr (listOf (oneOf [types.yk8s.networking.ipv4Addr types.yk8s.networking.ipv4Cidr types.yk8s.networking.subdomainName]));
      default = [];
    ...
    custom_ntp_pools = mkOption {
      description = ''
        A list of NTP pools.
      '';
      type = with types; listOf (oneOf [types.yk8s.networking.ipv4Addr types.yk8s.networking.ipv6Addr types.yk8s.networking.subdomainName]);
      default = [];
