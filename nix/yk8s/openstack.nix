{
  ...
  commonNodeDefaultOptions = {
    ...
    root_disk_volume_type = mkOption {
      ...
      '';
      type = types.nullOr types.yk8s.openstack.volumeTypeName;
      default = null;
    };
  };
...
in {
  options.yk8s.openstack = mkTopSection {
    ...
    keypair = mkOption {
      ...
      '';
      type = with types; nullOr types.yk8s.openstack.keypairName;
      default = null;
    };
    ...
    azs = mkOption {
      ...
      default = [];
      type = with types; listOf types.yk8s.openstack.availabilityZoneName;
    };
    ...
    dns_nameservers_v4 = mkOption {
      type = with types; listOf types.yk8s.networking.ipv4Addr;
      default = [];
    ...
    worker_defaults = recursiveUpdate commonNodeDefaultOptions {
      ...
      anti_affinity_group = mkOption {
        ...
        '';
        type = with types; nullOr types.yk8s.openstack.serverGroupName;
        default = null;
      };
    };
    ...
    nodes = mkOption {
      ...
      type = types.attrsOf (types.submodule {
        options = {
          ...
          image = mkOption {
            type = with types; nullOr types.yk8s.openstack.imageName;
            default = null;
          };
          flavor = mkOption {
            type = with types; nullOr types.yk8s.openstack.flavorName;
            default = null;
          };
          az = mkOption {
            type = with types; nullOr types.yk8s.openstack.availabilityZoneName;
            default = null;
          };
          root_disk_size = mkOption {
          ...
          root_disk_volume_type = mkOption {
            type = with types; nullOr types.yk8s.openstack.volumeTypeName;
            default = null;
          };
          anti_affinity_group = mkOption {
            description = ''
    ...
    network_name = mkOption {
      ...
      '';
      type = with types; nullOr types.yk8s.openstack.networkName;
      default = null;
